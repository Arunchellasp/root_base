// ============================================================
// GtsHal.h - GoogolTech GTS-400 series motion control card hardware abstraction layer
// Link requirements: gts.lib (or gts_x64.lib) + gts.dll (runtime)
//
// Use guide:
// 1. GtsHal::open()
// 2. GtsHal::reset()
// 3. GtsHal::loadConfig(configFile), then GtsHal::clrSts() and GtsHal::zeroPos().
// 4. Configure profile/interpolation parameters, enable axes, command motion, and poll status.
// 5. Use GtsErrorToString() when a wrapped GT_* call returns a non-zero error code.
// 6. Stop motion when needed, disable axes, then call GtsHal::close() before exit.
//
// Return value convention: 0 means success; non-zero values can be passed to GtsErrorToString().
// ============================================================
#ifndef GTSHAL_H
#define GTSHAL_H
...
// ============================================================
// Convert error code to string (debug helper)
// ============================================================
...
// ============================================================
// GtsHal - C++ static wrapper for all GT_XXX functions
// ============================================================
...
public:
    ...
    static short zeroPos(short axis = 1 , short count = 1) { return GT_ZeroPos(axis, count); }
    ...
    // ====================================================================
    // 4. Trapezoidal / Point-to-Point
    // ================================================================
    static short setVel(short profile, double vel) { return GT_SetVel(profile, vel); }            // Get velocity in trap mode
    ...
    // ====================================================================
    // 7. Follow Motion (Electronic Cam)
    // ====================================================================
    ...
    // ====================================================================
    // 9. Interpolation / Coordinate System
    // ====================================================================
    ...
    // Buffer operations (IO/delay/laser during interpolation)
    ...
    // Buffer laser instructions (called during interpolation)
    ...
    // ====================================================================
    // 30. Grouped Axis / Motion Smoothing
    // ====================================================================
    ...
    // ====================================================================
    // 33. PosCompare (newer position compare)
    // ====================================================================
